...
public class UserEntrySet extends AbstractEntrySet<UserEntrySet.UserEntry> {
    ...
    public void addSingleResult(ResultSet resultSet) throws SQLException {
        ...
        UserEntry userEntry = new UserEntry(id, name, time, money, rightGuesses, lastDaily, stardust, cookies, maxWaifus);
    ...
    public static class UserEntry extends AbstractEntry {
        ...
        public UserEntry(String id, String name, int time, int money, int rightGuesses, String lastDaily, int stardust, int cookies, int maxWaifus) {
            this.id = id;
            this.name = name;
            this.time = time;
            this.money = money;
