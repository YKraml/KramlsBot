...
public class WaifuEntrySet extends AbstractEntrySet<WaifuEntrySet.WaifuEntry> {
  ...
  public void addSingleResult(ResultSet resultSet) throws SQLException {
    ...
    WaifuEntry waifuEntry = new WaifuEntry(id, idMal, rarity, level, xp, baseHp, baseAtt, baseDef,
        baseInit, owner, imageUrl, starLevel);
  ...
  public static class WaifuEntry extends AbstractEntry {
    ...
    public WaifuEntry(String id, int idMal, String rarity, int level, int xp, int baseHp,
