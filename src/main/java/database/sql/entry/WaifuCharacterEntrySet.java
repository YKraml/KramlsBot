...
public class WaifuCharacterEntrySet extends AbstractEntrySet<WaifuCharacterEntry> {
  ...
  public void addSingleResult(ResultSet resultSet) throws SQLException {
    ...
    WaifuCharacterEntry waifuCharacterEntry = new WaifuCharacterEntry(idMal, id, rarity, level, xp,
        baseHp, baseAtt, baseDef, baseInit, owner, imageUrl, starLevel,
  ...
  public static class WaifuCharacterEntry extends AbstractEntry {
    ...
    public WaifuCharacterEntry(int idMal, String id, String rarity, int level, int xp, int baseHp,
        int baseAtt, int baseDef, int baseInit, String owner, String imageUrl, int starLevel,
