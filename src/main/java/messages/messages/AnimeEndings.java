...
public class AnimeEndings extends MyMessage {
  ...
  public AnimeEndings(AnimeFullById anime, AnimeThemes animeThemes, PlayerLoader playerLoader,
  ...
  protected void startRoutine(Message message) throws MyOwnException {
    ...
    message.addReactionAddListener(
        new AnimeStartSongReactionListener(anime, animeThemes.getData().getEndings(), "Endings",
