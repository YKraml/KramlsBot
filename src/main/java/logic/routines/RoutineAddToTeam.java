...
public class RoutineAddToTeam extends Routine {
  ...
  public RoutineAddToTeam(PlayerLoader playerLoader, TextChannel channel, User user,
      String teamName, int waifuIndex) {
  ...
  Answer start(RoutineRunner routineRunner) throws MyOwnException {
    ...
    try {
      ...
      channel.sendMessage(
          player.getNameTag() + ", \"" + waifu.getName() + "\" ist nun im Team \"" + team.get()
              .getName() + "\"");
