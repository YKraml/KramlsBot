...
public class RoutineRemoveFromGroup extends Routine {
  ...
  public RoutineRemoveFromGroup(User user, String groupName, int waifuNumber, TextChannel channel,
      GroupLoader groupLoader, MessageSender messageSender, PlayerLoader playerLoader) {
    this.user = user;
